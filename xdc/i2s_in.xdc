create_clock -period 81.380 -name i2s_in_mclki [get_ports i2s_in_mclki]
...
create_clock -period 81.380 -name i2s_in_bclki0 [get_ports {i2s_in_bclk[0]}]
...
set_clock_groups -name async_sys_i2s -asynchronous -group [get_clocks -include_generated_clocks clk_50mhz] -group [get_clocks -include_generated_clocks i2s_in_mclki] -group [get_clocks -include_generated_clocks i2s_in_bclki0] -group [get_clocks -include_generated_clocks i2s_in_bclko0]
