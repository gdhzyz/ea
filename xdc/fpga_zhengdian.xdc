...
# leds
set_property -dict {LOC V9 IOSTANDARD LVCMOS15} [get_ports led1]
set_property -dict {LOC Y8 IOSTANDARD LVCMOS15} [get_ports led2]

# Push buttons
set_property -dict {LOC U7 IOSTANDARD LVCMOS15} [get_ports reset_n]

# uart
set_property -dict {LOC D17 IOSTANDARD LVCMOS33} [get_ports uart_tx]
set_property -dict {LOC E14 IOSTANDARD LVCMOS33} [get_ports uart_rx]
